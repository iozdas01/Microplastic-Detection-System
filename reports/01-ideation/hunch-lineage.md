...
_Removed 2026-09-15: H2 (desalination pre-treatment), H3 (California drinking-water utilities), H4 (EU wastewater monitoring) and H5 (membrane makers), at the founder's direction (founder: "let's delete everything and stay in textile wet processing"). None carried evidence H1 borrows. Their ids stay burned; next_hunch_id remains H6. Git history holds the full entries._
